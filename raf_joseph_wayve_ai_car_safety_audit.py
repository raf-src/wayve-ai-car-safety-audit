...
print(df[["Weather", "Time of Day","Same direction Vehicle Traffic", "Road Type", "Oncoming vehicle traffic", "Cross vehicle traffic", 
          "Pedestrian crossing road", "Pedestrian on sidewalk", "Cyclists / motorbike present", "Large Exposure Change", "Traffic Light Change", 
          "Changing brake light / indicator", "Danger Score"]].head(20))
